...
class ToastContainer extends Component {
  ...
  _renderSuccessView = () => {
    return(
      <View style={[
        ...
        props.type === 'light' && {backgroundColor: 'rgba(58, 218, 129, 0.1)'}
      ]}>
        {this.props.icon ? 
          this.props.icon 
        : <SuccessIcon color={props.type === 'light' ? '#3ADA81' : '#FFFFFF'} width={scale(20)} height={scale(20)}/>}
        <Text
          allowFontScaling={false}
          numberOfLines={4}
          style={[styles.message, {color: props.type === 'light' ? '#3ADA81' : '#FFFFFF'}]}
        >
          {this.props.children}
        </Text>
      </View>
  ...
  _renderFailedView = () => {
    return (
      <View style={[styles.container, {backgroundColor: '#FB7181'}, props.type === 'light' && {backgroundColor: 'rgba(251, 113, 129, 0.1)'}]}>
        {this.props.icon ? this.props.icon  : <ErrorIcon color={props.type === 'light' ? '#FB7181' : '#FFFFFF'} width={scale(20)} height={scale(20)}/>}
        <Text
            allowFontScaling={false}
            numberOfLines={4}
            style={[styles.message, {color: props.type === 'light' ? '#FB7181' : '#FFFFFF'}]}>{this.props.children}
        </Text>
      </View>
    );
  }
  ...
  _renderWaringView = () => {
    return (
      <View style={[styles.container, {backgroundColor: '#FFC833'},  props.type === 'light' && {backgroundColor: 'rgba(255, 200, 51, 0.1)'}]}>
        {this.props.icon ? this.props.icon  : <WarningIcon color={props.type === 'light' ? '#FFC833' : '#FFFFFF'} width={scale(20)} height={scale(20)}/>}
        <Text
            allowFontScaling={false}
            numberOfLines={4}
            style={[styles.message, {color: props.type === 'light' ? '#FFC833' : '#FFFFFF'}]}>{this.props.children}
        </Text>
      </View>
    );
  }
