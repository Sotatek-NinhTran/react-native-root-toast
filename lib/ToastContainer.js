...
const positions = {
  BOTTOM: 0 - scale(20),
  TOP: isIphoneX() ? scale(34) : scale(20),
  CENTER: 0
};
...
class ToastContainer extends Component {
  ...
  _show = () => {
      ...
      if (!this._animating) {
          ...
          Animated.timing(this.state.animationY, {
            ...
            this.state.animationY.setValue(this.props.position);
          })
      }
  };
  ...
  render() {
      ...
      let position = offset === 0 ? {
        top: dimen.height * 0.5
      } :
      {
        [offset < 0 ? 'bottom' : 'top']: offset < 0 ? (_keyboardHeight - offset) : offset
      };
          ...
          >
              ...
              >
                  ...
                  >
                      ...
                      {!props.success && !props.failed && !props.warning && this._renderDefaultView()}
                  </Animated.View>
              </TouchableWithoutFeedback>
          </View> 
      : null
